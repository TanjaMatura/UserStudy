...
<ul class="collection">
 <!-- 1-10  -->
	...
	<li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url1")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url2")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url3")%>><img src="statistics.png" border="0"></button>
    </li>
<li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url4")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url5")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url6")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url7")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url8")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url9")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url10")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url11")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url12")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url13")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url14")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url15")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url16")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url17")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url18")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url19")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url20")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url21")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url22")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url23")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url24")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url25")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url26")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url27")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url28")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url29")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url30")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url31")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url32")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url33")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url34")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url35")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url36")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url37")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url38")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url39")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url40")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url41")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url42")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url43")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url44")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url45")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url46")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url47")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url48")%>><img src="statistics.png" border="0"></button>
    </li>
    <li class="collection-item avatar">
      ...
      <button class="secondary-content" type="submit" name="link" style="border: 0px;" value=<%=request.getSession().getAttribute("url49")%>><img src="statistics.png" border="0"></button>
    </li>
    </ul>
